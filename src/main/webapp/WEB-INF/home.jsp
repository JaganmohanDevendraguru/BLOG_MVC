...
<div class="container-fluid">
	...
	<!-- Second division -->
	<div class="row bg-light">
		<div style="height: 65vh" class="row w-100">
			<div class="col-md-10 offset-md-1">
				<div class="card-deck">
					<div class="card shadow-sm">
						<img class="card-img-top" src="images/make_money.png"
							alt="Card image cap">
						<div class="card-body">
							<h5 class="card-title">Earn Money from Home!</h5>
							<p class="card-text text-justify">This is a wider card with
								supporting text below as a natural lead-in to additional
								content. This content is a little bit longer.</p>
						</div>
					</div>
					<div class="card shadow-sm">
						<img class="card-img-top" src="images/share_ideas.png"
							alt="Card image cap">
						<div class="card-body">
					...
					<div class="card shadow-sm">
						<img class="card-img-top" src="images/programming.jpeg"
							alt="Card image cap">
						<div class="card-body">
							<h5 class="card-title">Learn to Coding!</h5>
							<p class="card-text text-justify">This is a wider card with
								supporting text below as a natural lead-in to additional
								content. This content is a little bit longer.</p>
						</div>
